...
export default class PlayerView {
    constructor(player) {
        ...
        this.player.on(Player.EVENT_SPECIAL, msg => {
            switch(msg.s) {
                case Special.NUKE: this.specialNuke(); break;
                case Special.QUAKE: this.specialQuake(); break;
                case Special.BOMB: this.specialBomb(); break;
                case Special.MOSES: this.specialMoses(); break;
                case Special.ZEBRA: this.specialZebra(); break;
                case Special.CLEAR_SPECIALS: this.specialClearSpecials(); break;
                case Special.INVENTORY_BOMB: this.specialInventoryBomb(); break;
            }
        });
